  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | STEP 2 — Analyze with AI (also generates the creative banners
      | server-side using the categoryId / subcategoryId / prompt /
      | bannerColor that were just saved on the product)
      |--------------------------------------------------------------------------
      */
